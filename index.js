...
const { ChainId, Token, TokenAmount, Route, Trade, TradeType } = require('@uniswap/sdk');
...
const main = async () => {
  try {
    ...
    const pair = new Route([{
      token: WETH,
      liquidity: '1000000000000000000', // 1 ETH in wei
    }, {
      token: DAI,
      liquidity: '1000000000000000000000', // Dummy liquidity for DAI, adjust as per actual liquidity
    }], WETH);
