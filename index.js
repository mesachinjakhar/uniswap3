...
async function main() {
    ...
    if (typeof window !== 'undefined') {
        // Use eth_requestAccounts method if running in a browser
    ...
    const path = [config.WETH_ADDRESS_MAINNET, 'TOKEN_ADDRESS_OF_DIA']; // Replace 'TOKEN_ADDRESS_OF_DIA' with the actual DIA token address
