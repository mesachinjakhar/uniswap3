...
const uniswapV3SwapArtifact = require('uniswap-v3-core/artifacts/contracts/UniswapV3Swap.sol/UniswapV3Swap.json');
...
async function main() {
    try {
        ...
        const factory = new ethers.ContractFactory(uniswapV3SwapArtifact.abi, uniswapV3SwapArtifact.bytecode, signer);
